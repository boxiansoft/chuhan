...
<table width="95%" border="1" cellspacing="0" cellpadding="0" bgcolor="#666666">
  <tr>
    <td height="30" style="background-image:url(images/bg_list.gif)"><div style="margin-left:10px;font-size:16px; font-weight:bold; color:#FFFFFF"><{$messageUserName}></div></td>
  </tr>
  <tr>
    <td bgcolor="#FFFFFF"><form id="systemNumber" name="systemNumber" action="" method="post"><table width="100%" border="0" cellspacing="0" cellpadding="0">
	  ...
	  <tr>
        ...
        <td><input name="" type="text" style="width:400px" value="<{$messageUserName}>"/></td>
      </tr>
	  <tr>
        <td height="25" align="right">用户电话：</td>
        <td><input name="" type="text" style="width:400px" value="<{$messageTel}>"/></td>
      </tr>
	  <tr>
        <td height="25" align="right">用户邮箱：</td>
        <td><input name="" type="text" style="width:400px" value="<{$messageEmail}>"/></td>
      </tr>
	  <tr>
