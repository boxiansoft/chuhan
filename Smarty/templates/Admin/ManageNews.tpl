    ...
    <td align="center"><table width="100%" border="0" cellspacing="0" cellpadding="0">
      ...
      <tr>
	   ...
	   <tr><td colspan="5"><hr width="100%" size="1" color="#CCCCCC"></td></tr>
	   	  <{foreach key = key item = item from = $newsArr}>
		  ...
		  <td align="left"><input name="selectid[]" type="checkbox" id="selectid" value="<{$item.id}>"></td>
			...
			<td height="30"><a href="../shownews.php?id=<{$item.id}>&classID=<{$item.newsClass}>" target="_blank"><{$item.title}></a></td>
			<td><{$item.className}></td>
			<td><{$item.addTime}></td>
			<td><a href="AddNews.php?newsID=<{$item.id}>">修改</a>&nbsp;|&nbsp;<a href="UpdateNews.php?action=deleteNews&newsID=<{$item.id}>">删除</a></td>
		 </tr>
		 <{/foreach}>
		 <tr><td colspan="5"><hr width="100%" size="1" color="#CCCCCC"></td></tr>
		    ...
		    <tr><td colspan="4" align="left"><input type="checkbox" name="checkbox2" value="Check All" onClick="allss()">全选 &nbsp;&nbsp;<input type="submit" name="Submit" value="删除选中内容" onClick="return scheck();"></td>
			 <tr>
			 <tr>
				<td colspan="5" bgcolor="#1D74CB" height="30" align="center"><div class="page"><{$page}></div></td>
			  </tr>
    </table></td>
  </tr>
</table>
