...
<table width="95%" border="1" cellspacing="0" cellpadding="0" align="center">
  ...
  <tr>
    <td><form name="addFriend" id="addFriend" action="UpdateNews.php?action=editerNews&newsID=<{$newsID}>" method="post">
	<table width="100%" border="0" cellspacing="0" cellpadding="0"  align="center" style="border:1px solid #CCCCCC">
      ...
      <tr>
        ...
        <td><input name="newsTitle" type="text" size="80" value="<{$newsTitle}>"/></td>
      </tr>
	  <tr>
	  ...
	  <tr>
        ...
        <td><input name="newsOrder" type="text" size="30" value="<{$newsOrder}>"/><font style="color:#FF0000; font-size:12px;">注：默认状态是“1”；</font></td>
      </tr>
	  <!--<tr>
        <td height="25"  align="right">新闻关键字：</td>
        <td><input name="newsKeyWords" type="text" size="100" value="<{$newsKeyWords}>"/></td>
      </tr>
	  <tr>
        <td height="25"  align="right">新闻描述：</td>
        <td><textarea name="newsDescription" cols="100" rows="6"><{$newsDescription}></textarea></td>
      </tr>-->
	  <tr>
