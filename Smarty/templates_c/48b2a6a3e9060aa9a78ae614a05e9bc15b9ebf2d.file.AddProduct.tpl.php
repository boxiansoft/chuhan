<?php /* Smarty version Smarty-3.1.9, created on 2013-03-17 03:36:27
         compiled from "C:\wamp\www\chuhan\Smarty\templates\Admin\AddProduct.tpl" */ ?>
<?php /*%%SmartyHeaderCode:22586513f1b1207a630-78042685%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '48b2a6a3e9060aa9a78ae614a05e9bc15b9ebf2d' => 
    array (
      0 => 'C:\\wamp\\www\\chuhan\\Smarty\\templates\\Admin\\AddProduct.tpl',
      1 => 1363491312,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '22586513f1b1207a630-78042685',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.9',
  'unifunc' => 'content_513f1b121d3811_09791429',
  'variables' => 
  array (
    'productID' => 0,
    'productUrl' => 0,
...
<?php if ($_valid && !is_callable('content_513f1b121d3811_09791429')) {function content_513f1b121d3811_09791429($_smarty_tpl) {?><?php if (!is_callable('smarty_function_html_radios')) include 'C:\\wamp\\www\\chuhan\\Smarty\\plugins\\function.html_radios.php';
...
"/></td>
	  ...
	  <tr>
        ...
        <td><input name="productTitle" type="text" size="60" value="<?php echo $_smarty_tpl->tpl_vars['productTitle']->value;?>
"/></td>
      </tr>
	  <tr>
...
"><?php echo $_smarty_tpl->tpl_vars['item']->value['cnClassName'];?>
	  ...
	  <tr>
        ...
        <td><input name="productPic" type="text" size="50" value="<?php echo $_smarty_tpl->tpl_vars['productPic']->value;?>
"/>&nbsp;&nbsp;&nbsp;&nbsp;<label style="cursor:hand" onClick="window.open('uploadPro/index.html','上传图片','height=200,width=400,top=200,left=200')">上传图片</label></td>
	  ...
	  <tr>
        ...
        <td><input name="detailPic" type="text" size="50" value="<?php echo $_smarty_tpl->tpl_vars['detailPic']->value;?>
"/></td>
      </tr>
	  <!--<tr>
